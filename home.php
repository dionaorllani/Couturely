...
<section class="category">
   ...
   <a href="category.php?category=blazer" class="swiper-slide slide">
      <img src=icons/blazer.png alt="">
      <h3>blazer</h3>
   </a>

   <a href="category.php?category=bodysuit" class="swiper-slide slide">
      <img src="icons/bodysuit.png" alt="">
      <h3>bodysuit</h3>
   </a>
